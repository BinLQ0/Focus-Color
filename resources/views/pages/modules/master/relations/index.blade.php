...
<div class="row d-flex justify-content-center">
    <div class="col-10">
        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-4">
                <x-button id='btn_create' :url='url("relations/create")' class='bg-success btn-sm'
        ...
        <x-card theme-mode='outline' theme='primary' component='tables.modules.master.relation-table' body-class='p-0' />
    </div>
</div>
@endsection

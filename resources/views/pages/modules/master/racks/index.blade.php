...
<div class="row d-flex justify-content-center">
    <div class="col-5">
        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-4">
                <x-button id='btn_create' :url='url("racks/create")' class='bg-success btn-sm' icon='far fa-plus-square' label='Create' />
            </div>
        ...
        <x-card theme-mode='outline' theme='primary' component='tables.modules.master.rack-table' body-class='p-0' />
    </div>
</div>
@endsection

...
<div class="row d-flex justify-content-center">
	...
	<div class="col-9">
        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-4">
                <x-button id='btn_create' :url='url("adjustment/create")' class='bg-success btn-sm'
                    icon='far fa-plus-square' label='Create' />
                    <x-button id='btn_download' :url='url("stocktaking/export")' class='bg-primary btn-sm'
                    icon='fas fa-file-download' label='Data Stocktaking' />
            </div>
        ...
        <x-card component='tables.adjustment-table' has-padding='true' />
    </div>
</div>

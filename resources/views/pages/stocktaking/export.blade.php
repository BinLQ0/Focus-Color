...
<div class="row d-flex justify-content-center">
    <div class="col-4">
        ...
        <h2 class="mb-3"> Export Stocktaking </h2>
        ...
        <x-card>
            ...
            <div class="row">
                <div class="col-12">
                    <x-date form='v' name='date' label="Cut off Date" />
                </div>
            </div>
        ...
        <x-card>
            ...
            <div class="row">
                <div class="col-12">
                    <x-date form='v' name='dateImport' label="Adjustment Date" />
                    <x-input form='v' name='file' type='file' class='form-control-plaintext align-center' label="Excel File to Upload" />
                </div>
            </div>

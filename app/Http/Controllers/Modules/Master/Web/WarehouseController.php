...
class WarehouseController extends Controller
{
    ...
    {
        return view('pages.modules.master.warehouses.index');
    }
    ...
    {
        return view('pages.modules.master.warehouses.createOrUpdate');
    }
    ...
    {
        return view('pages.modules.master.warehouses.createOrUpdate', compact('warehouse'));
    }

...
class RackController extends Controller
{
    ...
    {
        return view('pages.modules.master.racks.index');
    }
    ...
    {
        return view('pages.modules.master.racks.createOrUpdate');
    }
    ...
    {
        return view('pages.modules.master.racks.createOrUpdate', compact('rack'));
    }

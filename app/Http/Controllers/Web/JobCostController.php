...
class JobCostController extends Controller
{
    ...
    {
        return view('pages.job-cost.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('jobcost')->with('toast_success', 'Created Successfully!');
    }
    ...
    {
        return view('pages.job-cost.edit', compact('jobcost'));
    }
